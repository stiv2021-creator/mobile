...
class _MainNavigationViewState extends State<MainNavigationView> {
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    _buildDrawerItem(Icons.grid_view_rounded, 'Dashboard', _currentIndex == 0, () => _navigateToPage(0), isDarkMode),
                    
                    _buildSectionTitle('COMERCIAL'),
                    _buildDrawerItem(Icons.person_outline, 'Clientes', _currentIndex == 1, () => _navigateToPage(1), isDarkMode),
                    _buildDrawerItem(Icons.inventory_2_outlined, 'Proveedores', _currentIndex == 2, () => _navigateToPage(2), isDarkMode),
                    _buildDrawerItem(Icons.local_offer_outlined, 'Remisiones', _currentIndex == 3, () => _navigateToPage(3), isDarkMode),
                    _buildDrawerItem(Icons.shopping_cart_outlined, 'Órdenes de Pedido', _currentIndex == 4, () => _navigateToPage(4), isDarkMode),
                    _buildDrawerItem(Icons.trending_up, 'Ventas', _currentIndex == 5, () => _navigateToPage(5), isDarkMode),
                    
                    _buildSectionTitle('ALMACÉN'),
                    _buildDrawerItem(Icons.inventory_2_outlined, 'Insumos', _currentIndex == 6, () => _navigateToPage(6), isDarkMode),
                    _buildDrawerItem(Icons.shopping_cart_outlined, 'Compras', _currentIndex == 7, () => _navigateToPage(7), isDarkMode),

                    _buildSectionTitle('PRODUCCIÓN'),
                    _buildDrawerItem(Icons.precision_manufacturing_outlined, 'Gestión de Producción', _currentIndex == 8, () => _navigateToPage(8), isDarkMode),
                    _buildDrawerItem(Icons.tune_outlined, 'Registro Diario', _currentIndex == 9, () => _navigateToPage(9), isDarkMode),

                    _buildSectionTitle('ADMINISTRACIÓN'),
                    _buildDrawerItem(Icons.badge_outlined, 'Empleados', _currentIndex == 10, () => _navigateToPage(10), isDarkMode),
                  ],
                ),
              ),
                      ...
                      child: Row(
                        children: [
                          const CircleAvatar(
                            ...
                            child: Text('MG', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text('Ver mi perfil →', style: TextStyle(color: Colors.grey, fontSize: 12)),
                              ],
                            ),
                          ),
                        ],
        ...
        child: BottomNavigationBar(
          ...
          onTap: (index) {
            if (index == 4) {
              ...
              if (index == 1) setState(() => _currentIndex = 6); // Stock (Insumos)
          ...
          items: const [
            BottomNavigationBarItem(icon: Icon(Icons.grid_view_rounded, size: 20), label: 'Inicio'),
            BottomNavigationBarItem(icon: Icon(Icons.inventory_2_outlined, size: 20), label: 'Stock'),
            BottomNavigationBarItem(icon: Icon(Icons.person_outline, size: 20), label: 'Clientes'),
            BottomNavigationBarItem(icon: Icon(Icons.trending_up, size: 20), label: 'Ventas'),
            BottomNavigationBarItem(icon: Icon(Icons.menu, size: 20), label: 'Menú'),
          ],
        ),
      ),
    );
  ...
  Widget _buildDrawerItem(IconData icon, String title, bool isSelected, VoidCallback onTap, bool isDarkMode) {
    return ListTile(
      dense: true,
      leading: Icon(
        icon, 
        size: 16, 
        color: isSelected ? const Color(0xFFD4AF37) : (isDarkMode ? Colors.white70 : Colors.black87),
      ),
      title: Text(
        title,
        style: TextStyle(
